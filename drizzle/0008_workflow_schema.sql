...
ALTER TYPE "ticket_status" ADD VALUE 'triaged_out';--> statement-breakpoint
...
CREATE UNIQUE INDEX "ticket_approvals_one_pending_per_thread" ON "ticket_approvals" ("graph_thread_id") WHERE "ticket_approvals"."status" = 'pending';--> statement-breakpoint
CREATE INDEX "ticket_approvals_ticket_id_idx" ON "ticket_approvals" ("ticket_id");--> statement-breakpoint
